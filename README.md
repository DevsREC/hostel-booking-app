...
|-------|------------|---------|---------|
| **Build Tool** | Vite | 5.0+ | Lightning-fast development and build |
| **Frontend Framework** | React | 18.0+ | Component-based UI development |
| **UI Library** | shadcn/ui | Latest | Modern, accessible component library |
| **Language** | TypeScript | 5.0+ | Type-safe JavaScript development |
| **Styling** | Tailwind CSS | 3.0+ | Utility-first CSS framework |
| **Backend Framework** | Django | 4.2+ | High-level Python web framework |
| **API Framework** | Django REST Framework | 3.14+ | Powerful REST API toolkit |
| **Database** | PostgreSQL | 15.0+ | Advanced relational database |
| **Caching** | Redis | 7.0+ | In-memory data structure store |
| **Task Queue** | Celery | 5.3+ | Distributed task queue |
| **Authentication** | JWT | Latest | Secure token-based authentication |
| **Payments** | Stripe API | Latest | Secure payment processing |
| **Hosting** | Hostinger | - | Cloud hosting and deployment |
...
# Hostinger Configuration (Production)
HOSTINGER_DB_HOST=your_hostinger_db_host
HOSTINGER_DB_PORT=3306
HOSTINGER_DB_NAME=your_production_db
HOSTINGER_DB_USER=your_production_user
HOSTINGER_DB_PASSWORD=your_production_password
```
...
# Authentication
VITE_JWT_STORAGE_KEY=rec_hostel_token

# Payment Configuration
VITE_STRIPE_PUBLISHABLE_KEY=pk_test_your_stripe_publishable_key

# App Configuration
VITE_APP_NAME=REC Hostel Booking
...
# 3️⃣ Configure Django for production
cd ../backend
pip install gunicorn
python manage.py collectstatic --noinput
python manage.py migrate --run-syncdb

# 4️⃣ Setup Hostinger database connection
# Update settings.py with Hostinger database credentials

# 5️⃣ Deploy using provided deployment script
